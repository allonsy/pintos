...
struct thread
{
  ...
  //struct semaphore recent_cpu_sema; /*lock for recentcpu and nice */
...
int thread_compute_priority(struct thread *t);
void thread_compute_all_priority(void);
